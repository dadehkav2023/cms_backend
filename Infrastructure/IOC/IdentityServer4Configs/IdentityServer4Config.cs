...
namespace Infrastructure.IOC.IdentityServer4Configs
{
    public static class IdentityServer4Config
    {
        ...
        public static IServiceCollection Add_SSOAPI_Config(this IServiceCollection services, string Client_Id, string Authority, string Audience)
        {
            ...
            }).AddJwtBearer(options =>
            {
                ...
                options.Events = new JwtBearerEvents
                {
                    OnTokenValidated = context =>
                    {
                        ...
                        string NationalCodeUser = context.Principal.FindFirstValue("Username");
