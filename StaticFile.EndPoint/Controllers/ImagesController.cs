...
namespace StaticFile.EndPoint.Controllers
{
    ...
    public class ImagesController : ControllerBase
    {
        ...
        public ImagesController(IHostingEnvironment hostingEnvironment, IConfiguration configuration)
        {
        ...
        {
            if (apiKey != configuration.GetSection("ApiSecretKey").Value)
            {
                return  BadRequest();
            }
            try
            {
                ...
                {
                    //upload
                    return Ok(await UploadFileASync(files));
                }
                else
                {
                    return BadRequest();
