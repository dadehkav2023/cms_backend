...
{
    public class EditArticleAttachmentServiceValidation : AbstractValidator<RequestEditArticleAttachmentViewModel>
    {
        private string[] extensions = {".pdf", ".doc", ".docx", ".rar", ".zip"};

        public EditArticleAttachmentServiceValidation()
        {
