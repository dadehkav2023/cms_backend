...
{
    public class NewStatementAttachmentServiceValidation : AbstractValidator<RequestNewStatementAttachmentViewModel>
    {
        private string[] extensions = {".pdf", ".doc", ".docx", ".rar", ".zip"};

        public NewStatementAttachmentServiceValidation()
        {
